...
import { educationApi, getApiErrorMessage } from "../../../lib/api";
...
const Education = () => {
  ...
  useEffect(() => {
    ...
    educationApi
      .getAll()
      .then((data) => !cancelled && setEducationData(data))
  ...
  return (
    <div
      className="text-white py-10 px-4  font-sans bg-transparent overflow-hidden"
      id="education"
    >
      <div className="max-w-5xl mx-auto">
        ...
        {!loading && error && (
          <p className="text-center text-red-400 font-mono text-sm">
            Failed to load education: {error}
          </p>
        )}
                    ...
                    >
                      ...
                      {edu.department && (
                        <p className="text-orange-100/70 text-sm mb-3 font-medium">
                          Dept: <span className="text-white">{edu.department}</span>
                        </p>
                      )}
                      ...
                      {edu.isCurrent && (
                        ...
                        >
                          <div className="text-[10px] font-mono text-orange-500/50 uppercase tracking-tighter italic">
                            System_Active // {edu.department || "Current"}
                          </div>
                        </motion.div>
                      )}
                    </div>
